...
export const translations = {
  en: {
    ...
    hero: {
      heading: "Software that makes complex things clear.",
      subheading: "Software engineer · fullstack and applied AI · UC Davis CS&E",
    ...
    projects: {
      ...
      title: "Projects",
      subtitle: "Two AI products, a fullstack marketplace, and an Android app from HCI research.",
    ...
    footer: {
      ...
      aboutLine2: "Software that makes complex things clear.",
  ...
  ko: {
    ...
    hero: {
      heading: "복잡한 것을 명확하게 만드는 개발자",
      subheading: "소프트웨어 엔지니어 · 풀스택 · 응용 AI · UC Davis CS&E",
    ...
    projects: {
      eyebrow: "만든 것들",
      title: "프로젝트",
      subtitle: "AI 제품 두 개, 풀스택 마켓플레이스, HCI 연구로 만든 Android 앱입니다.",
    ...
    footer: {
      ...
      aboutLine2: "복잡한 것을 명확하게 만드는 개발자",
      copyright: "© 2026 Jinho Yon.",
    },
  },
} as const;
